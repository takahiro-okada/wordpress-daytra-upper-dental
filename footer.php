  ...
  <div class="l-footer__inner l-inner">
    <div class="l-footer__contents p-footer-contents">
      <div class="p-footer-contents__info">
        ...
        <div class="p-footer-contents__tel p-company-tel"><img src="<?php echo get_template_directory_uri(); ?>/dist/img/common/icon-tel.svg">03-1234-5678</div>
        <div class="p-footer-contents__working-time">(年中無休 AM9:00〜PM22:00)</div>
